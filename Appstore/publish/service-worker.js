import { config as unoConfig } from "/package_18535fcad5c17609c8860bb6bb9b0fe33d495424/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('6b28ee58-8d68-4303-9bb2-5497f55e3f39').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== '6b28ee58-8d68-4303-9bb2-5497f55e3f39';
